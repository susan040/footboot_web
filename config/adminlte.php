...
return [
    ...
    */
    ...
    'logo' => '<b>Foot</b>boot',
    'logo_img' => 'images/footboot_logo.jpeg',
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => true,
        'img' => [
            'path' => 'images/footboot_logo.jpeg',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => 50,
            'height' => 50,
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Vendors',
            'route' => 'superadmin.vendors.index',
        ...
        ['header' => 'account_settings', 'role' => 'superadmin'],
        [
            'text' => 'Profile',
        ...
        [
            'text' => 'Venue',
            'route'  => 'vendor.venues.index',
            'icon' => 'nav-icon fas fa-square',
            'role' => 'vendor'
        ],
        [
            'text' => 'Customer',
